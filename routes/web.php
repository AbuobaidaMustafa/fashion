...
Route::post('category', [ItemController::class, 'store'])->name('item.store');
Route::get('category/{category}', [ItemController::class, 'show'])->name('item.show');
Route::get('category/edit/{category}', [ItemController::class, 'edit'])->name('item.edit');
Route::put('category/{category}', [ItemController::class, 'update'])->name('item.update');
Route::post('category/{category}', [ItemController::class, 'destroy'])->name('item.destroy');
Route::post('category/dataAjax', [ItemController::class, 'dataAjax'])->name('item.dataAjax');
